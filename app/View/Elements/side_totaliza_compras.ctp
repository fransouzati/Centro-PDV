    ...
    <div class="panel panel-default" id="totalizando">
        ...
        <div class="panel-body">
            <div class="alert alert-info" role="alert">
                ...
                <a tabindex="0" role="button" data-toggle="popover" title="Pedidos Entregues" data-content="Pedidos que já foram entregues, mas que ainda não foram pagos." data-placement="top" data-trigger="focus" class="pull-right"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></a>
            </div>
            <div class="alert alert-warning" role="alert">
                <h1><span class="rs">R$</span> <?php echo array_sum($realizados); ?></h1>
                <span>Pedidos Realizados</span>
                <a tabindex="0" role="button" data-toggle="popover" title="Pedidos Realizados" data-content="Pedidos feitos, mas que ainda não foram entregues." data-placement="top" data-trigger="focus" class="pull-right"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></a>
            </div>
            <div class="alert alert-success" role="alert">
                <h1><span class="rs">R$</span> <?php echo array_sum($entreguesPagos); ?></h1>
                <span>Pedidos Entregues e Pagos</span>
                <a tabindex="0" role="button" data-toggle="popover" title="Pedidos Entregues e pagos" data-content="Transações Concluidas, onde o pedido realizado já foi entregue e pago." data-placement="top" data-trigger="focus" class="pull-right"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span></a>
            </div>

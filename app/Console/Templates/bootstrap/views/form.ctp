				...
				<div class="panel panel-default">
					<div class="panel-heading">Ações</div>
						<div class="panel-body">
							...
							<?php endif; ?>
									<li><?php echo "<?php echo \$this->Html->link(__('<span class=\"glyphicon glyphicon-list\"></span>&nbsp;&nbsp;Listar " . $pluralHumanName . "'), array('action' => 'index'), array('escape' => false)); ?>"; ?></li>
							<?php
									$done = array();
...
<?php
				echo "\t\t\t\t<div class=\"form-group\">\n";
				echo "\t\t\t\t\t<?php echo \$this->Form->submit(__('Enviar'), array('class' => 'btn btn-default')); ?>\n";
				echo "\t\t\t\t</div>\n\n";
